...
(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '  height: 100px;',
      '  border-radius: 50%;',
      '  background: radial-gradient(circle at 40% 40%, var(--accent, #F5C542), #F5C542);',
      '  box-shadow: 0 0 40px rgba(245,197,66, 0.5), 0 0 80px rgba(245,197,66, 0.3);',
      ...
      '  border: 2px solid var(--accent, #F5C542);',
      ...
      '  box-shadow: 0 0 14px rgba(245,197,66,.25);',
      '}',
      '[data-energy] {',
      '  transition: opacity .3s, transform .3s;',
      '}',
  ...
  function initVoiceAnalysis(contentArea) {
    ...
    heading.style.cssText = 'margin:0 0 14px;font-weight:700;font-size:1rem;color:#F5EADC';
    ...
    /* --- Analysis logic --- */
    var TAG_COLORS = {
      purple: 'background:rgba(245,197,66,.2);color:#F5C542;border:1px solid rgba(245,197,66,.35)',
      teal:   'background:rgba(245,197,66,.2);color:#F5C542;border:1px solid rgba(245,197,66,.35)',
      green:  'background:rgba(245,197,66,.2);color:#F5C542;border:1px solid rgba(245,197,66,.35)',
      yellow: 'background:rgba(245,197,66,.2);color:#F5C542;border:1px solid rgba(245,197,66,.35)',
      red:    'background:rgba(255,107,107,.2);color:#FF6B6B;border:1px solid rgba(255,107,107,.35)',
      blue:   'background:rgba(245,197,66,.2);color:#F5C542;border:1px solid rgba(245,197,66,.35)',
    };
